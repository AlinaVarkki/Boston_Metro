...
public class View {
     ...
     * Calls createMap to get the path displayed on a map
    ...
    /**
     * This function is used to read in the FXML file displaying the map selector and setting up the communication
     * between the map and this class, it will also gather all the coordinates from the buttons used later to display
     * found path on a map image
     */
