...
public class PathDisplayer {
    ...
    /**
     * @param name,color,x,y wrapper function that creates an element with a circle and the first station, styling them appropriately
    ...
    /**
     * @param name,color,x,y wrapper function that creates an element with a circle and the final station, styling them appropriately
     *                       calls displayLineLabel and makeTripleCircle with appropriate arguments
     * @return Hbox of a circle and station name
     */
    ...
    /**
     * @param name,color1,color2,x,y wrapper function that creates an element with a circle and a changing station, styling them appropriately
